...
macro_rules! invoke_handler {
    () => {
        tauri::generate_handler![
            ...
            $crate::commands::git_set_upstream,
            $crate::commands::git_cherry_pick,
            $crate::commands::git_revert_commit,
            $crate::commands::git_reset,
            $crate::commands::git_rebase,
            $crate::commands::git_stash_list,
            $crate::commands::git_stash_push,
            $crate::commands::git_stash_apply,
            $crate::commands::git_stash_pop,
            $crate::commands::git_stash_drop,
            $crate::commands::git_list_tags,
            $crate::commands::git_create_tag,
            $crate::commands::git_delete_tag,
            $crate::commands::git_push_tags,
            $crate::commands::git_search_commits,
            $crate::commands::git_diff_branches,
